...
<html>
<head>
<title>mmARTHouse | Pages | Contact</title>
<meta charset="utf-8">
...
<div class="wrapper row0">
  <div id="topbarcon" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <div class="fl_left">
      <ul>
					...
					<div class="col-md-4">
						...
						<ul class="contact-info">
							...
							<li><i class="fa fa-globe"></i><a href="#">&nbsp;www.mmarthouse.co.za</a></li>
 							<li>
               <a target="_blank" href="http://web.facebook.com/mmarthouse/"><i class="fa fa-facebook"></i>&nbsp;Facebook</a>
							</li>
 							<li>
								<a target="_blank" href="http://www.instagram.com/mmarthouse/"><i class="fa fa-instagram"></i>&nbsp;Instagram</a>
							</li>
						</ul>
					</div>
					<div class="col-md-8 ">
						<div class="row">
                            <form id="contact-form" class='contact-form' method="post">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <textarea name="message" class="form-control" id="msg" cols="30" rows="7" placeholder="Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="form-group">
					...
					<div id="map" class="col-md-12 ">
						<iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=1%20Hillcrest%20Avenue%20Criaighall%20Park%20Gauteng%20South%20Africa%202196&amp;t=m&amp;z=15&amp;output=embed&amp;iwloc=near" aria-label="1 Hillcrest Avenue Criaighall Park Gauteng South Africa 2196">
						</iframe>				
					</div>
