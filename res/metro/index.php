...
<head>
    ...
    <title>Metro Fit HTML CSS template</title>
<!--
Metro Fit
...
<?php						
	...
	foreach($images as $image)
	{
		...
		$li = '<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-pad-0">';
		$li .= '<a href="'.$image.'">';
		$li .= '<img src="'.$image.'" alt="Image" class="img-fluid tm-header-img"></a></div>';
            ...
            <div class="row tm-nav-2-row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <nav class="tm-flex-center">
                        <ul class="tm-nav-2">
                            <li class="tm-nav-item-2"><a href="" class="tm-nav-link-2">Home</a></li>
