	...
	$(document).ready(function(){
	  ...
	  gapHeight = 100;
		...
		var blindscontainer = $('#blindscontainer');

		blindscontainer.width(width).height(height);
		var blindWidth = width / numberOfBlinds;

	  images = new Array();
		$('ul li', blindscontainer).each(function() {
		images.push($(this)); 
	  });
	  ...
	  for (var i = 0; i < numberOfBlinds; i++) {
		...
		blindscontainer.prepend(tempEl);
	  };

	  blinds = $('span', blindscontainer);
